### Для того, чтобы попасть в школу Яндеса по **node.js** нужно выполнить просто тестовое задание.
#### Оно заключалось в несложной форме с проверкой валдиности данных и отправкой ajax-запроса
