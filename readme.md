### Для того, чтобы попасть в школу Яндеса по **node.js** нужно выполнить простое тестовое задание.
#### Оно заключалось в простой форме с проверкой валдиности данных и отправкой ajax-запроса
